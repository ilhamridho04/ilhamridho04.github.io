...
let users = [
    { id: 1, username: 'miknode', password: '12345', ipmik: 'id1.cbnet.team', usermik: 'ilhamridho', portmik: '', passmik: 'ilham1212' },
    { id: 2, username: 'ilham', password: 'ilham1212', ipmik: 'id1.cbnet.team', usermik: 'ilhamridho', portmik: '', passmik: 'ilham1212' }
];
var conn = new RosApi({
    host: users.ipmik,
    user: users.usermik,
    port: users.portmik,
    password: users.passmik,
});
...
module.exports = function (app) {
    ...
    app.get('/register', function (req, res) {
        if (req.user) { res.redirect('Dashboard/index'); } else {
